...
class Synset(object):
    ...
    def res_similarity(self, other):
        ...
        infoconts = [synset.infocont for synset in common_hypers if synset.infocont!=0]
    ...
    def jcn_distance(self, other):
        ...
        - `other`:
        '''
        MIN_INFOCONT = .0000000150070867666
        ic1 = max(self.infocont,MIN_INFOCONT)
        ic2 = max(other.infocont,MIN_INFOCONT)
        # if ic1 == 0 or ic2 == 0:
        #     return 0.
        ic1 = -math.log(ic1)
        ic2 = -math.log(ic2)
